...
export const SOCIAL_LINKS: SocialLink[] = [
  {
    name: 'github',
    url: 'https://github.com/kittenwarrior-qb',
    icon: 'icon-[ri--github-fill]',
    count: 11,
  },
  {
    name: 'linkedin',
    url: 'https://www.linkedin.com/in/qu%E1%BB%91c-b%C3%B9i-567542388/',
    icon: 'icon-[ri--linkedin-box-fill]',
  },
  {
    name: 'youtube',
    url: 'https://www.youtube.com/@imquocbui',
...
export const GITHUB_CONFIG: GithubConfig = {
  ENABLED: true,
  GITHUB_USERNAME: 'kittenwarrior-qb',
